...
### 🔑 Login
- **Arabic Login:**  
  ![Login Arabic](docs/images/login-ar.png)
- **English Login:**  
  ![Login English](docs/images/login-en.png)

---

### 📊 Dashboard (User)
- **Arabic Light Mode:**  
  ![Dashboard Arabic Light](docs/images/dashboard-ar-light.png)
- **Arabic Dark Mode:**  
  ![Dashboard Arabic Dark](docs/images/dashboard-ar-dark.png)
- **English Light Mode:**  
  ![Dashboard English Light](docs/images/dashboard-en-light.png)
- **English Dark Mode:**  
  ![Dashboard English Dark](docs/images/dashboard-en-dark.png)

---

### 🛠️ Dashboard (Admin)
- **English Light Mode:**  
  ![Admin Dashboard Light](docs/images/admin-dashboard-en-light.png)
- **English Dark Mode:**  
  ![Admin Dashboard Dark](docs/images/admin-dashboard-en-dark.png)

---

### 📂 Data & Records
![Data Records](docs/images/data-records.png)
...
### ✅ Payment Process
![Payment Process](docs/images/payment-process.png)
---
